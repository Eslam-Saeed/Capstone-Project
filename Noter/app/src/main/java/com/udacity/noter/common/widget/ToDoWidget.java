...
public class ToDoWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent intent1 = new Intent(context, ActivityToDo.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && intent.getAction().equals(AppWidgetManager.ACTION_APPWIDGET_UPDATE)) {
            int[] ids = appWidgetManager.getAppWidgetIds(new ComponentName(context.getApplicationContext(), ToDoWidget.class));
